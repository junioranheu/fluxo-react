                    ...
                    <div className='card-avaliacao'>
                        <div className='columns'>
                            <div className='column is-half'>
                                <div className='row'>
                                    <div className='icon'>
                                        <svg id='icon-bad' version='1.1' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 103.696 103.695'>
                                        ...
                                        <svg id='icon-ok' version='1.1' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 103.696 103.695'>
                                        ...
                                        <svg version='1.1' id='icon-good' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 103.696 103.696'>
                                        ...
                                        <svg version='1.1' id='icon-great' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 103.696 103.696'>
                            ...
                            <div className='column is-hidden-mobile esconder' id='divAvaliacaoSvg'>
                                <figure className='image is-256x256 has-image-centered sem-highlight'>
                                    <img src={ImagemAvaliacao} alt='Erro' />
                                </figure>
                            </div>
                        </div>
                    </div>
